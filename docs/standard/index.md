...
애플리케이션이나 서비스 또는 시스템의 일부 구성 요소를 .NET Core로 이식하려는 경우 [.NET Framework에서.NET Core로 포팅](../core/porting/index.md)을 확인하세요.
...
또한 .NET의 주요 언어 세 가지는 다음의 각 언어 가이드에서 확인해 보세요.
